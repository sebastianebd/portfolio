...
export default function Home() {
  return (
    ...
    <div className="relative lg:width-full h-screen md:h-170 lg:h-screen bg-[var(--color-bg)] overflow-hidden lg:px-20 justify-center">
      <NavBar/>
      ...
      {/* Contenedor columnas */}
      <div className="relative z-10 flex md:justify-content h-full max-w-screen-xl  mx-auto">


        {/* Columna izquierda */}
        <div className="text-white lg:flex-1 h-full flex flex-col  lg:justify-center gap-15 lg:gap-3 pt-15 px-5 lg:px-0  
                        pb-15 lg:pb-40">
          ...
          <p className="text-sm md:text-base pr-0 text-gray-500 font-bold pb-10">Soy un apasionado diseñador de UI/UX con la misión de crear experiencias digitales atractivas e 
        ...
        <div className=" lg:flex-1 h-full hidden lg:flex  pb-50 justify-center ">
          ...
          <div className="relative flex items-center">
            ...
            <Image
              ...
              width={500}
              height={450}
              className="z-10 xl:width-[500px] xl:height-[450px] xl:min-w-[400px] xl:min-h-[350px]
                        lg:width-[350px] lg:height-[300px] lg:min-w-[350px] lg:min-h-[300px]" 

            />
            </div>
            
            <svg viewBox="415 4 350 350" 
