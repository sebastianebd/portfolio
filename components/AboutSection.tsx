    ...
    >
      ...
      >
        <div className="pt-6 md:pt-16 md:px-15 lg:px-0 px-5 pb-10 lg:max-w-150 lg:flex-col lg:pr-3">
          <h1 className="text-amber-500 text-xl font-medium tracking-wide">
            ABOUT ME
          </h1>
          ...
          <div className="lg:flex  gap-4 pt-20">
            ...
            <p className="text-gray-400 text-md pt-10 md:pt-15 lg:pt-0 flex lg:max-w-full leading-loose xl:text-lg">
