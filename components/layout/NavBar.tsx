...
const NavBar = () => {
  ...
  const inputClass =
    "hover:-translate-y-1.5 transition-all duration-300 hover:rotate-1 hover:text-amber-400";
  return (
    <nav className="fixed top-0 left-0 w-full z-30 flex justify-center">
      <div
        className="fixed top-0 h-15 md:h-20 w-full max-w-360 mx-auto flex bg-[var(--color-navbar)] text-white 
                      font-bold  z-30"
      >
        ...
        <div className=" flex justify-center items-center pl-5 lg:pr-20">
          <a href="#home" className="text-md md:text-lg tracking-wider">
            SEBASTIÁN
          </a>
        </div>
        ...
        <div className="hidden md:flex flex-1 justify-evenly items-center gap-4 sm:gap-4 md:gap-5 px-3 ">
          <a href="#home" className={inputClass}>
            HOME
          </a>
          <a href="#about" className={inputClass}>
            ABOUT
          </a>
          <a href="#projects" className={inputClass}>
            PROJECTS
          </a>
          <a href="#contact" className={inputClass}>
            CONTACT
          </a>
        </div>
