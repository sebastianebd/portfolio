...
const NavBar = () => {
  ...
  return (
    <nav className='relative top-0 h-15 md:h-20 w-full max-w-6xl mx-auto flex bg-[var(--color-navbar)] text-white 
      ...
      <div className='bg-amber-500 text-black  flex-shrink-0  w-16 md:w-[250px] flex items-center justify-center '>
        <img src="/code-icon.svg" alt="terminal icon" height={35} width={35}/>
      </div>

      <div className=' flex justify-center items-center pl-5'>
        <a href="#home" className='text-sm md:text-lg tracking-wider'>SEBASTIÁN</a>
      </div>

      {/* Menú Desktop */}
      <div className='hidden flex-1 justify-evenly items-center gap-4 sm:gap-4 md:gap-5 lg:gap-7 px-3 '>
      ...
      <button
        className="md:hidden text-2xl focus:outline-none pl-35 text-amber-500"
